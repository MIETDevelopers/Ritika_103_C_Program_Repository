...
int main(){
    ...
    {
        case '+':
            printf("%.2lf + %.2lf = %.2lf",a, b); //Addition Function
            break;

        case '-':
            printf("%.2lf - %.2lf = %.2lf",a, b); //Subtraction Function
            break;

        case '*':
            printf("%.2lf * %.2lf = %.2lf",a, b; //Multiplication Function
            break;

        case '/':
            printf("%.2lf / %.2lf = %.2lf",a, b); //Division Function
            break;
